...
| Thoth Attribute | ONIX XPath | Transformation | Notes |
|---|---|---|---|
...
| `edition` | `/onix:ONIXMessage/onix:Product/onix:DescriptiveDetail/onix:Edition/onix:EditionNumber` | None | Edition number, defaults to 1 if not specified |
